...
//    	System.out.println(loggeduser_id);
        ...
        try {
            ...
            String sql = "INSERT INTO Post(book_code,book_name,autor_name,sem_book,book_img,book_condition,actual_price,discount,new_price,Current_Time_Stamp,user_id) values (?, ?, ?,?,?,?,?,?,?,CURRENT_TIMESTAMP,?)";
            ...
            pstmtSelect.setInt(1, numberRow);
